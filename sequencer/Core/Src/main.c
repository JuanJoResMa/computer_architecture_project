...
enum note {
	...
	C5, Cs5, D5, Ds5, E5, F5, Fs5, G5, Gs5, A5, As, B5,
	C6, Cs6, D6, Ds6, E6, F6, Fs6, G6, Gs6, A6, As6, B6, END,
};

uint16_t note_to_freq[] = {
...
uint8_t notes[] = {G5, G5, A5, G5, C6, B5, G5, G5, A6, G5, D5, C5, G5, G5, Gs5, E5, C5, D5, A5, F5, F5, E5, C5, D5, C5, END};
uint16_t note_num;
uint16_t period = 333;
/* USER CODE END PV */
